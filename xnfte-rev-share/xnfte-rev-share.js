...
const xNFTEcontractABI  = [{"stateMutability":"view","type":"function","name":"balanceOf","inputs":[{"name":"addr","type":"address"},{"name":"_t","type":"uint256"}],"outputs":[{"name":"","type":"uint256"}]}];

const xNFTEontractAddress = // "0xA7AF63b5154eB5d6Fb50a6d70d5C229e5f030AB2";

const xNFTEcontract = new ethers.Contract(xNFTEcontractAddress, xL2DAOContractABI, customHttpProviderArbitrum);
...
async function loadHolders(){
    ...
    while(i<=totalSupply){
        ...
        if ( ! tokenOwners.includes(tokenOwner) ) {
            ...
            .then((balance) => console.log("xNFTE Balance: ",ve_for_at = ethers.utils.formatEther(balance)));
